...
@PojoMapping(table = "ab_comm_log", primaryKey = {"uuid"})
public class CommLogEntity extends EntityDM {

	private static final long serialVersionUID = 1265467287068134617L;
	@Mapping(table = "ab_comm_log", columns = {"uuid"}, primaryKey = true)
	private String uuid;
	@Mapping(table = "ab_comm_log", columns = {"tran_date"}, requisite = true)
	private String tranDate;
	@Mapping(table = "ab_comm_log", columns = {"teller_code"}, requisite = true)
	private String tellerCode;
	@Mapping(table = "ab_comm_log", columns = {"tran_seq"}, requisite = true)
	private String tranSeq;
	@Mapping(table = "ab_comm_log", columns = {"comm_code"}, requisite = true)
	private String commCode;
	@Mapping(table = "ab_comm_log", columns = {"system_code"})
	private String systemCode;
	@Mapping(table = "ab_comm_log", columns = {"front_seq"})
	private String frontSeq;
	@Mapping(table = "ab_comm_log", columns = {"front_code"})
	private String frontCode;
	@Mapping(table = "ab_comm_log", columns = {"front_name"})
	private String frontName;
	@Mapping(table = "ab_comm_log", columns = {"tran_time"})
	private Long   tranTime;
	@Mapping(table = "ab_comm_log", columns = {"comm_time"})
	private Long   commTime;
	@Mapping(table = "ab_comm_log", columns = {"org_code"})
	private String orgCode;
	@Mapping(table = "ab_comm_log", columns = {"auth_teller_code"})
	private String authTellerCode;
	@Mapping(table = "ab_comm_log", columns = {"business_type"})
	private String businessType;
	@Mapping(table = "ab_comm_log", columns = {"rsp_status"})
	private Integer rspStatus;
	@Mapping(table = "ab_comm_log", columns = {"acc_date"})
	private String accDate;
	@Mapping(table = "ab_comm_log", columns = {"acc_time"})
	private String accTime;
	@Mapping(table = "ab_comm_log", columns = {"rsp_seq"})
	private String rspSeq;
	@Mapping(table = "ab_comm_log", columns = {"rsp_msg"})
	private String rspMsg;
	@Mapping(table = "ab_comm_log", columns = {"req_data"})
	private byte[] reqData;
	@Mapping(table = "ab_comm_log", columns = {"source_seq"})
	private String sourceSeq;
	@Mapping(table = "ab_comm_log", columns = {"debit_account_num"})
	private String debitAccountNum;
	@Mapping(table = "ab_comm_log", columns = {"debit_account_name"})
	private String debitAccountName;
	@Mapping(table = "ab_comm_log", columns = {"debit_account_sub_num"})
	private String debitAccountSubNum;
	@Mapping(table = "ab_comm_log", columns = {"debit_account_seq"})
	private String debitAccountSeq;
	@Mapping(table = "ab_comm_log", columns = {"credit_account_num"})
	private String creditAccountNum;
	@Mapping(table = "ab_comm_log", columns = {"credit_account_name"})
	private String creditAccountName;
	@Mapping(table = "ab_comm_log", columns = {"money"})
	private Double money;
	@Mapping(table = "ab_comm_log", columns = {"curr_type"})
	private String currType;
	@Mapping(table = "ab_comm_log", columns = {"available"})
	private Integer available;
	@Mapping(table = "ab_comm_log", columns = {"last_modify_user"})
	private String lastModifyUser;
	@Mapping(table = "ab_comm_log", columns = {"last_modify_date"})
