...
package cn.com.agree.ab.lib.cache.impl;
 ...
 * @see GuavaCache
 */
@AutoBindMapper(baseClass = CacheManager.class)
@Singleton
...
public class GuavaCacheManager implements CacheManager {
	...
	private CacheBuilder<Object, Object> cacheBuilder = CacheBuilder
														.newBuilder()
														//.maximumSize(16)	//最大缓存参数，缓存cacheMap中最多只可缓存16个cache对象
														.expireAfterWrite(60, TimeUnit.MINUTES);	// 缓存更新后60分钟自动失效
	...
	public void setCacheBuilder(CacheBuilder<Object, Object> cacheBuilder) {
		Preconditions.checkNotNull(cacheBuilder, "CacheBuilder must not be null");
	...
	public void setCacheLoader(CacheLoader<Object, Object> cacheLoader) {
		if (!ObjectUtil.nullSafeEquals(this.cacheLoader, cacheLoader)) {
	...
	private void doSetCacheBuilder(CacheBuilder<Object, Object> cacheBuilder) {
		if (!ObjectUtil.nullSafeEquals(this.cacheBuilder, cacheBuilder)) {
