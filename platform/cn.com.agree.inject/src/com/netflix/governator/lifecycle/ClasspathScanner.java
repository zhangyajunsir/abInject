...
public class ClasspathScanner {
    ...
    // modify by zyj private final -> protected
    protected Set<Class<?>> classes;
    protected Set<Constructor> constructors;
                ...
                while ( resources.hasMoreElements() ) {
                    ...
                    try {
                        if ( isJarURL(url)) {
                            ...
                            try (JarFile jar = new JarFile(file)) {	// need jdk 1.7
    ...
    protected void applyFinderResults(Set<Class<?>> localClasses, Set<Constructor> localConstructors, Set<Method> localMethods, Set<Field> localFields, AnnotationFinder finder) {
